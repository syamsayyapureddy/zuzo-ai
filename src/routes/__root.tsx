...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZuZo AI — Your Smart Pet Care Companion" },
      { name: "description", content: "AI-powered pet care: instant answers, food recommendations, training tips, and nearby vet support in one intelligent platform." },
      { name: "author", content: "ZuZo AI" },
      { property: "og:title", content: "ZuZo AI — Your Smart Pet Care Companion" },
      { property: "og:description", content: "AI-powered pet care: instant answers, food recommendations, training tips, and nearby vet support in one intelligent platform." },
